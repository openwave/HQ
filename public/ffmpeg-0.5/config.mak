...
FFMPEG_CONFIGURATION=--enable-gpl --enable-postproc --enable-swscale --enable-avfilter --enable-avfilter-lavf --enable-pthreads --enable-avisynth --enable-libfaac --enable-libfaad --enable-libmp3lame --enable-libspeex --enable-libtheora --enable-libvorbis --enable-libxvid --enable-libx264 --enable-memalign-hack
prefix=/usr/local
...
LN_S=ln -sf
STRIP=strip
OPTFLAGS= -D_ISOC99_SOURCE -D_POSIX_C_SOURCE=200112 -std=c99 -fomit-frame-pointer -DPTW32_STATIC_LIB -g -Wdeclaration-after-statement -Wall -Wno-switch -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wundef -O3 -fno-math-errno
VHOOKCFLAGS=-fPIC
...
EXTRALIBS=  -lz -lbz2 -lpthreadGC2 -lws2_32 -lm -lvfw32 -lfaac -lfaad -lmp3lame -lm -lspeex -ltheora -logg -lvorbisenc -lvorbis -logg -lx264 -lm -lxvidcore  -lws2_32 -lvfw32
ARCH=x86
ARCH_X86=yes
ARCH_X86_32=yes
HAVE_AMD3DNOW=yes
...
SRC_PATH="/d/dev/ffmpeg-0.5"
SRC_PATH_BARE=/d/dev/ffmpeg-0.5
BUILD_ROOT="/d/dev/ffmpeg-0.5"
